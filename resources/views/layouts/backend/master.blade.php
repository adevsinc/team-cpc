...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../">
  ...
  <link href="{{ asset('frontend_assets/media/images/favicon.ico') }}" rel="icon" sizes="32x32" type="image/png"/>
 ...
 <body class="flex h-full text-base antialiased text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
  <!-- Theme Mode -->
  <script>
  ...
  <div class="flex grow">
   ...
   <!-- End of Sidebar -->
   <!-- Wrapper -->
   <div class="flex flex-col kt-wrapper grow">
    <!-- Header -->
    <header class="fixed top-0 z-10 flex items-stretch kt-header start-0 end-0 shrink-0 bg-background" data-kt-sticky="true" data-kt-sticky-class="border-b border-border" data-kt-sticky-name="header" id="header">
     <!-- Container -->
     <div class="flex items-stretch justify-between kt-container-fixed lg:gap-4" id="headerContainer">
      <!-- Mobile Logo -->
      <div class="flex gap-2.5 lg:hidden items-center -ms-1">
       <a class="shrink-0" href="html/demo1.html">
        <img class="max-h-[25px] w-full" src="{{ asset('frontend_assets') }}/media/app/mini-logo.svg"/>
       </a>
        ...
        <div class="hidden lg:flex lg:items-stretch [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]" data-kt-drawer="true" data-kt-drawer-class="kt-drawer kt-drawer-start fixed z-10 top-0 bottom-0 w-full me-5 max-w-[250px] p-5 lg:p-0 overflow-auto" id="mega_menu_wrapper">
         ...
         <div class="kt-menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-kt-menu="true" id="mega_menu">
          ...
          <div class="kt-menu-item active">
           <a class="text-sm font-medium kt-menu-link text-nowrap text-foreground kt-menu-item-hover:text-primary kt-menu-item-active:text-mono kt-menu-item-active:font-medium" href="html/demo1.html">
          ...
          <div class="kt-menu-item" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="accordion|lg:dropdown" data-kt-menu-item-trigger="click|lg:hover">
           <div class="text-sm kt-menu-link text-foreground kt-menu-link-hover:text-primary kt-menu-item-active:text-mono kt-menu-item-show:text-primary kt-menu-item-here:text-mono kt-menu-item-active:font-medium kt-menu-item-here:font-medium">
            <span class="kt-menu-title text-nowrap">
             Profiles
            </span>
            <span class="flex kt-menu-arrow lg:hidden">
             <span class="kt-menu-item-show:hidden text-muted-foreground">
              <i class="text-xs ki-filled ki-plus">
              </i>
             </span>
             <span class="hidden kt-menu-item-show:inline-flex">
              <i class="text-xs ki-filled ki-minus">
              </i>
             </span>
            </span>
           </div>
           <div class="kt-menu-dropdown w-full gap-0 lg:max-w-[900px]">
            <div class="pt-4 pb-2 lg:p-7.5">
             <div class="grid gap-5 lg:grid-cols-2 lg:gap-10">
              <div class="flex-col kt-menu kt-menu-default kt-menu-fit">
          ...
          <div class="kt-menu-item" data-kt-menu-item-offset="-300px, 0" data-kt-menu-item-offset-rtl="300px, 0" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="accordion|lg:dropdown" data-kt-menu-item-trigger="click|lg:hover">
           <div class="text-sm font-medium kt-menu-link text-secondary-foreground kt-menu-link-hover:text-primary kt-menu-item-active:text-mono kt-menu-item-show:text-primary kt-menu-item-here:text-mono kt-menu-item-active:font-semibold kt-menu-item-here:font-semibold">
            <span class="kt-menu-title text-nowrap">
             My Account
            </span>
            <span class="flex kt-menu-arrow lg:hidden">
            ...
            <div class="kt-menu-item" data-kt-menu-item-placement="right-start" data-kt-menu-item-placement-rtl="left-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
             <div class="kt-menu-link">
              ...
              <span class="kt-menu-arrow">
               <i class="text-xs ki-filled ki-right rtl:transform rtl:rotate-180">
               </i>
              </span>
             </div>
            ...
            <div class="kt-menu-item">
             <a class="kt-menu-link" href="https://keenthemes.com/metronic/tailwind/docs/getting-started/license" tabindex="0">
              ...
              <span class="kt-menu-badge" data-kt-tooltip="#menu_tooltip_3">
               <i class="text-base ki-filled ki-information-2 text-muted-foreground">
               </i>
              </span>
      ...
      <div class="flex items-center gap-2.5">
       ...
       <button class="group kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-primary/10 hover:[&_i]:text-primary" data-kt-modal-toggle="#search_modal">
        <i class="text-lg ki-filled ki-magnifier group-hover:text-primary">
        </i>
       </button>
       <!-- End of Search -->
       <!-- Notifications -->
       <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-primary/10 hover:[&_i]:text-primary" data-kt-drawer-toggle="#notifications_drawer">
        <i class="text-lg ki-filled ki-notification-status">
        </i>
       </button>
       ...
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="notifications_drawer">
        ...
        <div class="justify-between px-5 mb-2 kt-tabs kt-tabs-line" data-kt-tabs="true" id="notifications_tabs">
         <div class="flex items-center gap-5">
          <button class="py-3 kt-tab-toggle active" data-kt-tab-toggle="#notifications_tab_all">
           All
          </button>
          <button class="relative py-3 kt-tab-toggle" data-kt-tab-toggle="#notifications_tab_inbox">
           Inbox
          ...
          <button class="py-3 kt-tab-toggle" data-kt-tab-toggle="#notifications_tab_team">
           Team
          </button>
          <button class="py-3 kt-tab-toggle" data-kt-tab-toggle="#notifications_tab_following">
           Following
          </button>
         </div>
        ...
        <div class="flex flex-col grow" id="notifications_tab_all">
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4 grow divider-y divider-border">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-4.png"/>
             </div>
            ...
            <div class="flex flex-col gap-3.5">
             <div class="flex flex-col gap-1">
              <div class="text-sm font-medium">
               <a class="font-semibold hover:text-primary text-mono" href="#">
                Joe Lincoln
               </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-5.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-27.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-10.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <img class="h-5" src="{{ asset('frontend_assets') }}/media/file-types/pdf.svg"/>
              <a class="text-xs font-medium hover:text-primary text-secondary-foreground me-1" href="#">
               Launch_nov24.pptx
              </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-11.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-14.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-offline size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-background rounded-sm border border-border">
               <img class="h-5" src="{{ asset('frontend_assets') }}/media/file-types/figma.svg"/>
              </div>
              <a class="text-xs font-medium hover:text-primary text-secondary-foreground me-1" href="#">
               Launcher-UIkit.fig
              </a>
         ...
         <div class="grid grid-cols-2 p-5 gap-2.5" id="notifications_all_footer">
          <button class="justify-center kt-btn kt-btn-outline">
           Archive all
          </button>
          <button class="justify-center kt-btn kt-btn-outline">
           Mark all as read
        ...
        <div class="flex flex-col hidden grow" id="notifications_tab_inbox">
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5" id="notification_request_13">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-25.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             <div class="flex flex-col gap-1">
              <div class="mb-px text-sm font-medium">
               ...
               <a class="font-semibold hover:text-primary text-primary" href="#">
                TechSynergy
               </a>
              </div>
              <span class="flex items-center text-xs font-medium text-muted-foreground">
             ...
             <div class="kt-card shadow-none flex items-center flex-row justify-between gap-1.5 px-2.5 py-2 rounded-lg bg-muted/70">
              <div class="flex flex-col">
               <a class="text-xs font-medium hover:text-primary text-mono" href="#">
                Ronald Richards
               </a>
               <a class="text-xs font-medium hover:text-primary text-muted-foreground" href="#">
                ronald.richards@gmail.com
               </a>
              </div>
              <a class="text-xs font-medium hover:text-primary text-secondary-foreground" href="#">
               Go to profile
              </a>
             </div>
             <div class="flex flex-wrap gap-2.5">
           ...
           <div class="flex items-center grow gap-2.5 px-5">
            <div class="flex items-center justify-center border border-green-200 rounded-full size-8 bg-green-50 dark:border-green-950">
             <i class="text-lg text-green-500 ki-filled ki-check">
             </i>
            </div>
            <div class="flex flex-col gap-1">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-34.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('frontend_assets') }}/media/file-types/xls.svg"/>
               <div class="flex flex-col gap-0.5">
                <a class="text-xs font-medium hover:text-primary text-secondary-foreground" href="#">
                 Redesign-2024.xls
                </a>
           ...
           <div class="flex gap-2 px-5 grow">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-29.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
             ...
             <div class="kt-card shadow-none p-3.5 gap-3.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-3.png"/>
                </div>
                <div class="flex">
                 <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png"/>
                </div>
               </div>
              </div>
              <div class="flex items-center gap-2.5">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-30.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-24.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
        ...
        <div class="flex flex-col hidden grow" id="notifications_tab_team">
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex gap-2 px-5 grow">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-15.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3 grow" id="notification_request_10">
             ...
             <div class="kt-card shadow-none p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               <div class="flex items-center gap-2.5">
                <div class="border rounded-lg border-primary/10">
                 <div class="flex items-center justify-center border-b rounded-t-lg border-b-primary/10 bg-primary/10">
                  <span class="text-xs text-primary fw-medium p-1.5">
                   Apr
                  </span>
                 </div>
                 <div class="flex items-center justify-center size-9">
                  <span class="tracking-tight fw-semibold text-mono text-md">
                   12
                  </span>
                 </div>
                </div>
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-4.png"/>
                </div>
                <div class="flex">
                 <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png"/>
                </div>
                <div class="flex">
                 <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png"/>
                </div>
                <div class="flex">
                 <span class="relative inline-flex items-center justify-center font-semibold leading-none text-white bg-green-500 rounded-full hover:z-5 shrink-0 ring-1 text-2xs size-6 ring-background">
                  +3
                 </span>
                </div>
               </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-6.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-12.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('frontend_assets') }}/media/file-types/word.svg"/>
               <div class="flex flex-col gap-0.5">
                <a class="text-xs font-medium hover:text-primary text-secondary-foreground" href="#">
                 Landing-page.docx
                </a>
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('frontend_assets') }}/media/file-types/svg.svg"/>
               <div class="flex flex-col gap-0.5">
                <a class="text-xs font-medium hover:text-primary text-secondary-foreground" href="#">
                 New-icon.svg
                </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-21.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
		...
		design is simply stunning! From layout to color, it's a work of art!
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-13.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
        ...
        <div class="flex flex-col hidden grow" id="notifications_tab_following">
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="flex items-center gap-2.5">
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="h-24 bg-no-repeat bg-cover kt-card-rounded-t shrink-0" style="background-image: url('{{ asset('frontend_assets') }}/media/images/600x600/6.jpg')">
               </div>
              ...
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="h-24 bg-no-repeat bg-cover kt-card-rounded-t shrink-0" style="background-image: url('{{ asset('frontend_assets') }}/media/images/600x600/1.jpg')">
               </div>
               <div class="px-2.5 pb-2">
                <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5" href="#">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_17">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-19.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded-sm border border-border">
               <img class="h-5" src="{{ asset('frontend_assets') }}/media/brand-logos/jira.svg"/>
              </div>
              <a class="text-xs font-medium hover:text-primary text-secondary-foreground me-1" href="#">
               User-feedback.jira
              </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-17.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 px-2.5 py-1.5 rounded-lg bg-muted/70">
              <i class="text-base text-green-500 ki-filled ki-user-tick">
              </i>
		...
		article
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-9.png"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
       ...
       <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-primary/10 hover:[&_i]:text-primary" data-kt-drawer-toggle="#chat_drawer">
        <i class="text-lg ki-filled ki-messages">
        </i>
       </button>
       <!--Chat Drawer-->
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="chat_drawer">
         ...
         <div class="border-b border-border py-2.5">
          <div class="flex flex-wrap items-center justify-between gap-2 px-5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-11">
             <img alt="" class="size-7" src="{{ asset('frontend_assets') }}/media/brand-logos/gitlab.svg"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              HR Team
             </a>
             <span class="text-xs italic font-medium text-muted-foreground">
              Jessy is typing..
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
            <div class="flex -space-x-2">
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('frontend_assets') }}/media/avatars/300-4.png"/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png"/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png"/>
             </div>
             <div class="flex">
            ...
            <div class="kt-menu" data-kt-menu="true">
             <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
              <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost">
               <i class="text-lg ki-filled ki-dots-vertical">
               </i>
              </button>
              <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
               <div class="kt-menu-item">
        ...
        <div class="kt-scrollable-y-auto grow" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="230px">
         <div class="flex flex-col gap-5 py-5">
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('frontend_assets') }}/media/avatars/300-5.png"/>
           <div class="flex flex-col gap-1.5">
          ...
          <div class="flex items-end justify-end gap-3.5 px-5">
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex bg-primary flex-col gap-2.5 p-3 rounded-be-none">
             <p class="font-medium text-2sm text-primary-foreground">
            ...
            <div class="relative flex items-center justify-end gap-2">
             ...
             <i class="absolute text-lg text-green-500 ki-filled ki-double-check">
             </i>
            </div>
           </div>
           <div class="relative shrink-0">
            <div class="kt-avatar size-9">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('frontend_assets') }}/media/avatars/300-4.png"/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png"/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
          ...
          <div class="flex items-end justify-end gap-3.5 px-5">
           <div class="flex flex-col gap-1.5">
            ...
            <div class="relative flex items-center justify-end gap-2">
             ...
             <i class="absolute text-lg ki-filled ki-double-check text-muted-foreground">
             </i>
            </div>
           </div>
           <div class="relative shrink-0">
        ...
        <div class="mb-2.5">
         <div class="flex grow gap-2 px-5 py-3.5 bg-accent/60 mb-2.5 border-y border-border" id="join_request">
          ...
          <div class="flex items-center justify-between gap-3 grow">
           ...
           <div class="flex gap-2.5">
            <button class="kt-btn kt-btn-sm kt-btn-outline" data-kt-dismiss="#join_request">
             Decline
            </button>
         ...
         <div class="relative mx-5 grow">
          <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png">
           <input class="h-auto py-4 bg-transparent kt-input ps-12" placeholder="Write a message..." type="text" value=""/>
        ...
        <div class="kt-dropdown-menu p-0 w-screen max-w-[320px]" data-kt-dropdown-menu="true">
         ...
         <div class="flex flex-col kt-scrollable-y-auto max-h-[400px] divide-y divide-border">
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-10">
             <img alt="" class="size-6" src="{{ asset('frontend_assets') }}/media/brand-logos/jira.svg">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-10">
             <img alt="" class="size-6" src="{{ asset('frontend_assets') }}/media/brand-logos/inferno.svg">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-10">
             <img alt="" class="size-6" src="{{ asset('frontend_assets') }}/media/brand-logos/evernote.svg"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Evernote
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-10">
             <img alt="" class="size-6" src="{{ asset('frontend_assets') }}/media/brand-logos/gitlab.svg"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Gitlab
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex flex-wrap items-center gap-2">
            <div class="flex items-center justify-center border rounded-full shrink-0 bg-accent/60 border-border size-10">
             <img alt="" class="size-6" src="{{ asset('frontend_assets') }}/media/brand-logos/google-webdev.svg"/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Google webdev
         ...
         <div class="grid p-5 border-t border-t-border">
          <a class="justify-center kt-btn kt-btn-outline" href="html/demo1/account/integrations.html">
           Go to Apps
          </a>
         </div>
        </div>
       ...
       <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
        <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
         <img alt="" class="border-2 border-green-500 rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png"/>
        </div>
        <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
         <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
          <div class="flex items-center gap-2">
           ...
           <div class="flex flex-col gap-1.5">
            ...
            <a class="text-xs font-medium leading-none text-secondary-foreground hover:text-primary" href="html/demo1/account/home/get-started.html">
             c.fisher@gmail.com
            </a>
           </div>
          </div>
          ...
          <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
           <button class="kt-dropdown-menu-toggle" data-kt-dropdown-toggle="true">
            ...
            <span class="kt-dropdown-menu-indicator">
             <i class="text-xs ki-filled ki-right">
             </i>
            </span>
           </button>
            ...
            <ul class="kt-dropdown-menu-sub">
             ...
             <li>
              <a class="kt-dropdown-menu-link" href="#">
               ...
               <span class="inline-flex items-center ms-auto" data-kt-tooltip="true" data-kt-tooltip-placement="top">
                <i class="text-base ki-filled ki-information-2 text-muted-foreground">
                </i>
          ...
          <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
           <button class="py-1 kt-dropdown-menu-toggle" data-kt-dropdown-toggle="true">
            ...
            <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
             English
             <img alt="" class="inline-block size-3.5 rounded-full" src="{{ asset('frontend_assets') }}/media/flags/united-states.svg"/>
            </span>
           </button>
            ...
            <ul class="kt-dropdown-menu-sub">
             <li class="active">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block rounded-full size-4" src="{{ asset('frontend_assets') }}/media/flags/united-states.svg"/>
                <span class="kt-menu-title">
                 English
                </span>
               </span>
               <i class="text-base text-green-500 ki-solid ki-check-circle ms-auto">
               </i>
              </a>
             </li>
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=rtl">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block rounded-full size-4" src="{{ asset('frontend_assets') }}/media/flags/saudi-arabia.svg"/>
                <span class="kt-menu-title">
                 Arabic(Saudi)
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block rounded-full size-4" src="{{ asset('frontend_assets') }}/media/flags/spain.svg"/>
                <span class="kt-menu-title">
                 Spanish
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block rounded-full size-4" src="{{ asset('frontend_assets') }}/media/flags/germany.svg"/>
                <span class="kt-menu-title">
                 German
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block rounded-full size-4" src="{{ asset('frontend_assets') }}/media/flags/japan.svg"/>
                <span class="kt-menu-title">
                 Japanese
                </span>
               </span>
         ...
         <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
          ...
          <a class="justify-center w-full kt-btn kt-btn-outline" onclick="logout()" style="cursor: pointer;">
           Log out
          </a>
          ...
          <script>
            function logout() {
                ...
                .catch(error => {
                    ...
                    // Fallback redirect if the fetch fails
                    window.location.href = '/access/login';
                });
            }
            </script>
    ...
    <footer class="kt-footer">
     ...
     <div class="kt-container-fixed">
      <div class="flex flex-col items-center justify-center gap-3 py-5 md:flex-row md:justify-between">
       ...
       <nav class="flex order-1 gap-4 text-sm font-normal md:order-2 text-secondary-foreground">
  ...
  <div class="kt-modal" data-kt-modal="true" id="search_modal">
   <div class="kt-modal-content max-w-[600px] top-[15%]">
    <div class="px-5 py-4 kt-modal-header">
     <i class="text-xl ki-filled ki-magnifier text-muted-foreground">
     </i>
    ...
    <div class="p-0 pb-5 kt-modal-body">
     <div class="kt-tabs kt-tabs-line justify-between px-5 mb-2.5" data-kt-tabs="true">
      <div class="flex items-center gap-5">
       <button class="py-5 kt-tab-toggle active" data-kt-tab-toggle="#search_modal_mixed">
        Mixed
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_settings">
        Settings
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_integrations">
        Integrations
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_users">
        Users
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_docs">
        Docs
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_empty">
        Empty
       </button>
       <button class="py-5 kt-tab-toggle" data-kt-tab-toggle="#search_modal_no-results">
        No Results
       </button>
      </div>
      <div class="-mt-px kt-menu" data-kt-menu="true">
     ...
     <div class="kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="300px">
      <div class="" id="search_modal_mixed">
       <div class="flex flex-col gap-2.5">
        ...
        <div>
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
          <div class="kt-menu-item">
           <div class="flex items-center gap-2 kt-menu-link jistify-between">
            <div class="flex items-center gap-2 grow">
             <div class="flex items-center justify-center border rounded-full size-10 shrink-0 border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('frontend_assets') }}/media/brand-logos/jira.svg"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Jira
          ...
          <div class="kt-menu-item">
           <div class="flex items-center gap-2 kt-menu-link jistify-between">
            <div class="flex items-center gap-2 grow">
             <div class="flex items-center justify-center border rounded-full size-10 shrink-0 border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('frontend_assets') }}/media/brand-logos/inferno.svg"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Inferno
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-14.png"/>
              </div>
              <div class="flex">
               <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-12.png"/>
              </div>
              <div class="flex">
               <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-9.png"/>
              </div>
             </div>
            </div>
           </div>
        ...
        <div>
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
          <div class="grid gap-1">
           <div class="kt-menu-item">
            <div class="flex justify-between gap-2 kt-menu-link">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-3.png"/>
              <div class="flex flex-col">
               <a class="mb-px text-sm font-semibold text-mono hover:text-primary" href="#">
                Tyler Hero
               </a>
               <span class="font-normal text-2sm text-muted-foreground">
           ...
           <div class="kt-menu-item">
            <div class="flex justify-between gap-2 kt-menu-link">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png"/>
              <div class="flex flex-col">
               <a class="mb-px text-sm font-semibold text-mono hover:text-primary" href="#">
                Esther Howard
               </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        ...
        <div class="kt-menu-item">
         <div class="flex items-center gap-2 kt-menu-link jistify-between">
          <div class="flex items-center gap-2 grow">
           <div class="flex items-center justify-center border rounded-full size-10 shrink-0 border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('frontend_assets') }}/media/brand-logos/evernote.svg"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Evernote
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-6.png"/>
            </div>
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-3.png"/>
            </div>
            ...
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-8.png"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="flex items-center gap-2 kt-menu-link jistify-between">
          <div class="flex items-center gap-2 grow">
           <div class="flex items-center justify-center border rounded-full size-10 shrink-0 border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('frontend_assets') }}/media/brand-logos/gitlab.svg"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Gitlab
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-18.png"/>
            </div>
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-17.png"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="flex items-center gap-2 kt-menu-link jistify-between">
          <div class="flex items-center gap-2 grow">
           <div class="flex items-center justify-center border rounded-full size-10 shrink-0 border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('frontend_assets') }}/media/brand-logos/google-webdev.svg"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Google webdev
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-20.png"/>
            </div>
            <div class="flex">
             <img class="relative rounded-full hover:z-5 shrink-0 ring-1 ring-background size-6" src="{{ asset('frontend_assets') }}/media/avatars/300-21.png"/>
            </div>
           </div>
          </div>
         </div>
        </div>
        <div class="px-4 pt-2 kt-menu-item">
         <a class="justify-center kt-btn kt-btn-outline" href="#">
          Go to Apps
         </a>
        </div>
       </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid gap-1">
         ...
         <div class="kt-menu-item">
          <div class="flex justify-between gap-2 kt-menu-link">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-11.png"/>
            <div class="flex flex-col">
             <a class="mb-px text-sm font-semibold text-mono hover:text-primary" href="#">
              Jacob Jones
             </a>
         ...
         <div class="kt-menu-item">
          <div class="flex justify-between gap-2 kt-menu-link">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-5.png"/>
            <div class="flex flex-col">
             <a class="mb-px text-sm font-semibold text-mono hover:text-primary" href="#">
              TLeslie Alexander
             </a>
         ...
         <div class="kt-menu-item">
          <div class="flex justify-between gap-2 kt-menu-link">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('frontend_assets') }}/media/avatars/300-2.png"/>
            <div class="flex flex-col">
             <a class="mb-px text-sm font-semibold text-mono hover:text-primary" href="#">
              Cody Fisher
             </a>
      ...
      <div class="hidden" id="search_modal_docs">
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid">
         <div class="kt-menu-item">
          <div class="flex items-center kt-menu-link">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('frontend_assets') }}/media/file-types/pdf.svg"/>
            <div class="flex flex-col">
             <span class="mb-px text-sm font-semibold cursor-pointer text-mono hover:text-primary">
              Project-pitch.pdf
             </span>
             <span class="text-xs font-medium text-muted-foreground">
         ...
         <div class="kt-menu-item">
          <div class="flex items-center kt-menu-link">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('frontend_assets') }}/media/file-types/doc.svg"/>
            <div class="flex flex-col">
             <span class="mb-px text-sm font-semibold cursor-pointer text-mono hover:text-primary">
              Report-v1.docx
             </span>
         ...
         <div class="kt-menu-item">
          <div class="flex items-center kt-menu-link">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('frontend_assets') }}/media/file-types/javascript.svg"/>
            <div class="flex flex-col">
             <span class="mb-px text-sm font-semibold cursor-pointer text-mono hover:text-primary">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="flex items-center kt-menu-link">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('frontend_assets') }}/media/file-types/ai.svg"/>
            <div class="flex flex-col">
             <span class="mb-px text-sm font-semibold cursor-pointer text-mono hover:text-primary">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="flex items-center kt-menu-link">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('frontend_assets') }}/media/file-types/php.svg"/>
            <div class="flex flex-col">
             <span class="mb-px text-sm font-semibold cursor-pointer text-mono hover:text-primary">
              appController.js
             </span>
      ...
      <div class="hidden" id="search_modal_empty">
       <div class="flex flex-col gap-5 text-center py-9">
        <div class="flex justify-center">
         <img alt="image" class="dark:hidden max-h-[113px]" src="{{ asset('frontend_assets') }}/media/illustrations/33.svg"/>
         <img alt="image" class="light:hidden max-h-[113px]" src="{{ asset('frontend_assets') }}/media/illustrations/33-dark.svg"/>
        </div>
        <div class="flex flex-col gap-1.5">
         <h3 class="text-base font-semibold text-center text-mono">
        ...
        <div class="flex justify-center">
         <a class="flex justify-center kt-btn kt-btn-outline" href="#">
          View Projects
         </a>
        </div>
       </div>
  ...
  <div class="kt-modal" data-kt-modal="true" id="share_profile_modal">
   <div class="kt-modal-content max-w-[500px] top-5 lg:top-[15%]">
    ...
    <div class="grid gap-5 px-0 py-5 kt-modal-body">
     <div class="flex flex-col px-5 gap-2.5">
      <div class="flex gap-1 flex-center">
       <label class="text-sm font-semibold text-mono">
        Share read-only link
       </label>
       <i class="text-sm ki-filled ki-information-2 text-muted-foreground">
       </i>
      </div>
     ...
     <div class="flex flex-col gap-4 px-5">
      ...
      <div class="flex flex-wrap justify-between gap-2 flex-center">
       <div class="flex flex-center gap-1.5">
        <i class="ki-filled ki-user text-muted-foreground">
        </i>
        <div class="flex text-xs font-medium flex-center text-secondary-foreground">
         Anyone at
         <a class="mx-1 text-xs font-medium link" href="#">
          KeenThemes
         </a>
         can view
        </div>
      ...
      <button class="justify-center kt-btn kt-btn-primary">
       Done
      </button>
     </div>
    </div>
  ...
  <div class="kt-modal" data-kt-modal="true" id="report_user_modal">
   <div class="kt-modal-content max-w-[500px] top-[15%]">
    ...
    <div class="p-0 kt-modal-body">
     <div class="p-5">
      <div class="grid gap-1 place-items-center">
       <div class="flex items-center justify-center rounded-full">
        <img class="rounded-full max-h-[55px] max-w-full" src="{{ asset('frontend_assets') }}/media/avatars/300-1.png"/>
       </div>
       <div class="flex items-center justify-center gap-1">
        <a class="text-sm font-semibold leading-5 hover:text-primary text-mono" href="#">
         Jenny Klabber
        </a>
     ...
     <div class="p-5 font-medium text-center text-2sm text-foreground">
  ...
  <script src="{{ asset('frontend_assets') }}/js/widgets/general.js">
  </script>
  <script src="{{ asset('frontend_assets') }}/js/layouts/demo1.js">
  </script>
  <!-- End of Scripts -->
 </body>
</html>
