<x-layouts.backend.master :title="'Dashboard'">
            ...
            <div class="grid lg:grid-cols-3 gap-y-5 lg:gap-7.5 items-stretch">
                <div class="lg:col-span-1">
                    <div class="grid grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
                        <style>
                            .channel-stats-bg {
                                background-image: url('{{ asset('frontend_assets') }}/media/images/2600x1600/bg-3.png');
                            }

                            .dark .channel-stats-bg {
                                background-image: url('{{ asset('frontend_assets') }}/media/images/2600x1600/bg-3-dark.png');
                            }
                        </style>
                        <div
                            ...
                            <img alt="" class="w-7 mt-4 ms-5"
                                src="{{ asset('frontend_assets') }}/media/brand-logos/linkedin-2.svg" />
                        ...
                        <div
                            class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                            <img alt="" class="w-7 mt-4 ms-5"
                                src="{{ asset('frontend_assets') }}/media/brand-logos/youtube-2.svg" />
                            <div class="flex flex-col gap-1 pb-4 px-5">
                                <span class="text-3xl font-semibold text-mono">
                                    24k
                                </span>
                        ...
                        <div
                            class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                            <img alt="" class="w-7 mt-4 ms-5"
                                src="{{ asset('frontend_assets') }}/media/brand-logos/instagram-03.svg" />
                            <div class="flex flex-col gap-1 pb-4 px-5">
                                <span class="text-3xl font-semibold text-mono">
                                    608
                                </span>
                        ...
                        <div
                            ...
                            <img alt="" class="dark:hidden w-7 mt-4 ms-5"
                                src="{{ asset('frontend_assets') }}/media/brand-logos/tiktok.svg" />
                            <img alt="" class="hidden dark:block w-7 mt-4 ms-5"
                                src="{{ asset('frontend_assets') }}/media/brand-logos/tiktok-dark.svg" />
                            <div class="flex flex-col gap-1 pb-4 px-5">
                                <span class="text-3xl font-semibold text-mono">
                                    2.5k
                                </span>
                ...
                <div class="lg:col-span-2">
                    <style>
                        .entry-callout-bg {
                            background-image: url('{{ asset('frontend_assets') }}/media/images/2600x1600/2.png');
                        }

                        .dark .entry-callout-bg {
                            background-image: url('{{ asset('frontend_assets') }}/media/images/2600x1600/2-dark.png');
                        }
                    </style>
                        ...
                        <div class="kt-card-content lg:p-7.5 lg:pt-6 p-5">
                            <div class="flex items-center justify-between flex-wrap gap-5 mb-7.5">
                                ...
                                <img alt="" class="size-7"
                                    src="{{ asset('frontend_assets') }}/media/brand-logos/zoom.svg" />
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-24.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-7.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            ...
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-8.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-9.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <span
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-6.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-10.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-11.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-12.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <span
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-13.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-14.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-15.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-16.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-17.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-18.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-19.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-20.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-21.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-22.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-23.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            ...
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-25.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-26.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-27.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-28.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <span
                                                                    class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-[30px] text-white ring-background bg-violet-500">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex -space-x-2">
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-29.png" />
                                                            </div>
                                                            <div class="flex">
                                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                    src="{{ asset('frontend_assets') }}/media/avatars/300-30.png" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
