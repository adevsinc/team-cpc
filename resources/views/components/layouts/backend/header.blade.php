                                    ...
                                    <div class="flex flex-col gap-3.5 grow">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img class="h-5"
                                                    src="{{ asset('frontend_assets') }}/media/file-types/figma.svg" />
                                            </div>
                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1"
                                                href="#">
                                                Launcher-UIkit.fig
                                                ...
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('frontend_assets') }}/media/avatars/300-3.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('frontend_assets') }}/media/avatars/300-2.png" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex items-center gap-2.5">
                                        ...
                                        <div class="kt-card shadow-none p-2.5 rounded-lg bg-muted/70">
                                            <div class="flex items-center justify-between flex-wrap gap-2.5">
                                                ...
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('frontend_assets') }}/media/avatars/300-4.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('frontend_assets') }}/media/avatars/300-1.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="{{ asset('frontend_assets') }}/media/avatars/300-2.png" />
                                ...
                                <div class="flex grow gap-2.5 px-5">
                                    ...
                                    <div class="flex flex-col gap-3.5 grow">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-1.5">
                                                <img class="h-6"
                                                    src="{{ asset('frontend_assets') }}/media/file-types/word.svg" />
                                                <div class="flex flex-col gap-0.5">
                                                    <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                                        href="#">
                                                        Landing-page.docx
                                        ...
                                        <div class="flex items-center gap-2.5">
                                            <div
                                                ...
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                                    style="background-image: url('{{ asset('frontend_assets') }}/media/images/600x600/6.jpg')">
                                                </div>
                                            ...
                                            <div
                                                class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                                    style="background-image: url('{{ asset('frontend_assets') }}/media/images/600x600/1.jpg')">
                                                </div>
                                                <div class="px-2.5 pb-2">
                                                    <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5"
                                                        href="#">
                                    ...
                                    <div class="flex flex-col gap-2.5 grow">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img class="h-5"
                                                    src="{{ asset('frontend_assets') }}/media/brand-logos/jira.svg" />
                                            </div>
                                            <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1"
                                                href="#">
                                                User-feedback.jira
                                ...
                                <div class="flex items-center flex-wrap gap-2">
                                    <div
                                        ...
                                        <img alt="" class="size-7"
                                            src="{{ asset('frontend_assets') }}/media/brand-logos/gitlab.svg" />
                                    </div>
                                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-col gap-5 py-5">
                            <div class="flex items-end gap-3.5 px-5">
                                <img alt="" class="rounded-full size-9"
                                    src="{{ asset('frontend_assets') }}/media/avatars/300-5.png" />
                                <div class="flex flex-col gap-1.5">
                                    <div
                            ...
                            <div class="flex items-center justify-between gap-3 grow">
                                <div class="flex flex-col">
                                    <div class="text-sm mb-px">
                                        <a class="hover:text-primary font-semibold text-mono"
                                            href="#">
                                            Jane Perez
                                        </a>
                                        <span class="text-secondary-foreground">
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div
                                        class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6"
                                            src="{{ asset('frontend_assets') }}/media/brand-logos/inferno.svg">
                                        </img>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary"
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div
                                        class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6"
                                            src="{{ asset('frontend_assets') }}/media/brand-logos/evernote.svg" />
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary"
                                            href="#">
                            ...
                            <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                <div class="flex items-center flex-wrap gap-2">
                                    <div
                                        class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                        <img alt="" class="size-6"
                                            src="{{ asset('frontend_assets') }}/media/brand-logos/google-webdev.svg" />
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-semibold text-mono hover:text-primary"
                                            href="#">
                                    ...
                                    <ul class="kt-dropdown-menu-sub">
                                        ...
                                        <li>
                                            <a class="kt-dropdown-menu-link"
                                                ...
                                                <input checked="" class="ms-auto kt-switch"
                                ...
                                <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
                                    ...
                                    <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
                                        ...
                                        <img alt="" class="inline-block size-3.5 rounded-full"
                                            src="{{ asset('frontend_assets') }}/media/flags/united-states.svg" />
                                    </span>
                                </button>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="?dir=rtl">
                                                <span class="flex items-center gap-2">
                                                    <img alt=""
                                                        class="inline-block size-4 rounded-full"
                                                        src="{{ asset('frontend_assets') }}/media/flags/saudi-arabia.svg" />
                                                    <span class="kt-menu-title">
                                                        Arabic(Saudi)
                                                    </span>
                                                </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                <span class="flex items-center gap-2">
                                                    <img alt=""
                                                        class="inline-block size-4 rounded-full"
                                                        src="{{ asset('frontend_assets') }}/media/flags/spain.svg" />
                                                    <span class="kt-menu-title">
                                                        Spanish
                                                    </span>
                                                </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                <span class="flex items-center gap-2">
                                                    <img alt=""
                                                        class="inline-block size-4 rounded-full"
                                                        src="{{ asset('frontend_assets') }}/media/flags/germany.svg" />
                                                    <span class="kt-menu-title">
                                                        German
                                                    </span>
                                                </span>
                                        ...
                                        <li class="">
                                            <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                <span class="flex items-center gap-2">
                                                    <img alt=""
                                                        class="inline-block size-4 rounded-full"
                                                        src="{{ asset('frontend_assets') }}/media/flags/japan.svg" />
                                                    <span class="kt-menu-title">
                                                        Japanese
                                                    </span>
                                                </span>
